...
@InputType()
class PlaylistTrackCreateNestedManyWithoutTracksInput {
...
export { PlaylistTrackCreateNestedManyWithoutTracksInput as PlaylistTrackCreateNestedManyWithoutTracksInput };
