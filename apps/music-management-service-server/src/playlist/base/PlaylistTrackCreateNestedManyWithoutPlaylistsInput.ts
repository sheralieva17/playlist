...
@InputType()
class PlaylistTrackCreateNestedManyWithoutPlaylistsInput {
...
export { PlaylistTrackCreateNestedManyWithoutPlaylistsInput as PlaylistTrackCreateNestedManyWithoutPlaylistsInput };
